...
@Component({
    selector: 'app-research-sireline-search',
    templateUrl: './sireline-search.component.html',
    styleUrls: ['./sireline-search.component.css']
})

export class SirelineSearchComponent implements AfterViewInit {
    ...
    loadData() {
        ...
        this.loading = true;
        this.subscription = this.horseService!.getHorsesForSirelineSearch(this.searchTypeCtrl.value, this.searchSiresCtrl.value.id)
            .subscribe(data => {
                this.loading = false;
